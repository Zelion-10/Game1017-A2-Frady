	...
	const int width, const int height, const int flags)
{
	...
	if (Mix_Init(MIX_INIT_MP3) != 0) {
		...
		backgroundMusic.emplace("titleMusic", Mix_LoadMUS("../Assets/mus/Title.mp3"));
		backgroundMusic.emplace("bgMusic", Mix_LoadMUS("../Assets/mus/bgMusic.mp3"));
		backgroundMusic.emplace("scream", Mix_LoadMUS("../Assets/mus/Scream.mp3"));
...
map<std::string, Mix_Music*> Engine::backgroundMusic; 
